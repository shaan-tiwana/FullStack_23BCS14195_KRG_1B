  ...
  const renderInputForm = () => (
    <form onSubmit={handleSubmit} className="w-full space-y-6">
      <div className="space-y-2">
        <label htmlFor="shareCode" className="text-lg font-medium text-gray-700">Enter Share Code:</label>
        <input
          id="shareCode"
          type="text"
          value={code}
  ...
  return (
    <div className="flex flex-col items-center w-full h-full max-w-lg mx-auto">
      <div className="flex justify-between w-full mb-4 items-center">
        <h2 className="text-2xl font-bold text-gray-800">Retrieve Document</h2>
